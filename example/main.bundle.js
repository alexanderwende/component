...
`;
    ...
    class OverlayService {
        ...
        configureOverlay(overlay, config = {}) {
            const overlayConfig = Object.assign(Object.assign({}, DEAFULT_OVERLAY_CONFIG), config);
        ...
        updateOverlayTrigger(overlay, config) {
            ...
            if (hasTriggerChanged || hasTriggerTypeChanged) {
                if (config.trigger && definition.overlayTrigger) {
                    definition.overlayTrigger.attach(document.querySelector(config.trigger));
                }
            }
        }
        /**
    ...
    let Overlay = class Overlay extends Component {
        ...
        updateCallback(changes, firstUpdate) {
            ...
            if (Object.keys(config).length > 0) {
                changes.forEach((val, key) => console.log('updateCallback... change: ', key, this[key]));
