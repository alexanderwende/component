...
`;
    ...
    let Overlay = class Overlay extends MixinRole(Component, 'dialog') {
        constructor() {
            super(...arguments);
        ...
        handleOpenChanged(event) {
            ...
            if (event.detail.current === true) {
                ...
                (_a = this.parentNode) === null || _a === void 0 ? void 0 : _a.replaceChild(this.marker, this);
                document.body.appendChild(this);
            }
            else {
                (_c = (_b = this.marker) === null || _b === void 0 ? void 0 : _b.parentNode) === null || _c === void 0 ? void 0 : _c.replaceChild(this, this.marker);
    ...
    let OverlayDemoComponent = class OverlayDemoComponent extends Component {
        ...
        updateCallback(changes, firstUpdate) {
            if (firstUpdate) {
                this.overlay = this.renderRoot.querySelector('ui-overlay');
            }
        }
        changeRole() {
