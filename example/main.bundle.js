...
`;
    ...
    class PositionManager {
        constructor(target, origin = document.body) {
            this.target = target;
            this.origin = origin;
        ...
        update(position) {
            this.lastPosition = Object.assign(Object.assign({}, DEFAULT_POSITION), position);
            if (!this.isUpdating) {
    ...
    class ConnectedPositionManager extends PositionManager {
    ...
    let Popover = class Popover extends Component {
        ...
        updateCallback(changes, firstUpdate) {
            if (firstUpdate) {
                ...
                this.renderRoot.querySelector('slot[name=template]').assignedNodes()[0].content, {
                    attributes: true,
                    characterData: true,
                    childList: true,
                    subtree: true,
        ...
        updateTemplate() {
            const templateSlot = this.renderRoot.querySelector('slot[name=template]');
            const contentSlot = this.renderRoot.querySelector('slot[name=content]');
            const template = templateSlot.assignedNodes()[0];
            if (!this.hidden) {
                requestAnimationFrame(() => {
