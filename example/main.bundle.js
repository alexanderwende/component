...
`;
    ...
    class ConnectedPositionStrategy extends PositionStrategy {
        ...
        getPosition() {
            ...
            return Object.assign(Object.assign({}, DEFAULT_POSITION), { top: `${origin.bottom}px`, left: `${origin.left}px` });
        }
        applyPosition(position) {
