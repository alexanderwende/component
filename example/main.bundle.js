...
`;
    ...
    const DEFAULT_OVERLAY_CONFIG = Object.assign(Object.assign({}, DEFAULT_POSITION_CONFIG), { positionType: 'fixed', trigger: undefined, triggerType: undefined, template: undefined, context: undefined, backdrop: true, closeOnEscape: true, closeOnBackdropClick: true, autoFocus: true, trapFocus: true, restoreFocus: true });
    ...
    class FocusTrap extends Behavior {
        constructor(config) {
            super();
    ...
    class DefaultOverlayTrigger extends Behavior {
        ...
        attach(element) {
            ...
            this.eventManager.listen(this.overlay, 'keydown', (event) => this.handleKeydown(event));
            this.update();
        }
        detach() {
            if (!this.hasAttached)
