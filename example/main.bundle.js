...
`;
    ...
    let Popover = class Popover extends Component {
        ...
        updateTemplate() {
            const contentSlot = this.renderRoot.querySelector('slot[name=content]');
