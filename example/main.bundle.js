...
`;
    ...
    class FixedPositionStrategy extends PositionStrategy {
        constructor() {
            super(...arguments);
            this.defaultPosition = Object.assign(Object.assign({}, DEFAULT_POSITION), { top: '50vh', left: '50vw', offsetHorizontal: '-50%', offsetVertical: '-50%' });
        }
        getPosition() {
    ...
    class OverlayService {
        ...
        createOverlay(template, context) {
