 ...
 * ```
 */
export const css = (literals: TemplateStringsArray, ...substitutions: any[]) => {

    return substitutions.reduce((prev: string, curr: any, i: number) => prev + curr + literals[i + 1], literals[0]);
};
